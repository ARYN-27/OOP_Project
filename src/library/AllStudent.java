...
public class AllStudent extends javax.swing.JFrame {
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SearchActionPerformed
        ...
        if (NameRadio.isSelected()) {
            ...
            JOptionPane.showMessageDialog(AllStudent.this, "Select Name or Email", "No Selection!",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllStudent.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
