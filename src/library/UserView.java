...
public class UserView extends javax.swing.JFrame {
    ...
    public static String MatricsNo;
    ...
    public UserView() throws SQLException {
        ...
        String MatricsNoIDV = MatricsNo;
        DefaultTableModel model;
        model = (DefaultTableModel) jTable1.getModel();
       
        try(Connection Con = DB.getConnection()) {
            PreparedStatement ps=Con.prepareStatement("select IssuedBook.BookID,Books.BookName , IssuedBook.IssueDate, IssuedBook.ReturnDate from Books,IssuedBook where Books.BookID=IssuedBook.BookID and IssuedBook.MatricsNo=?",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
