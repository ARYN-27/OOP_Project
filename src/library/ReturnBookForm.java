...
public class ReturnBookForm extends javax.swing.JFrame {
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(MatricsNo, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                335, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(20, 20, 20)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(MatricsNo, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel2))
                                .addGap(34, 34, 34)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        if (TransBookDBConn.BookValidate(BookID.getText()) && TransBookDBConn.UserValidate(MatricsNo.getText())) {
            if (TransBookDBConn.CheckIssuedBook(BookIDV)) {
                ...
                if (TransBookDBConn.ReturnBook(BookIDV, MatricsNoIDV) != 0) {
                    JOptionPane.showMessageDialog(ReturnBookForm.this, "Book is returned by the User!",
                            "Returning Book Successfull!", JOptionPane.ERROR_MESSAGE);
                    MatricsNo.setText("");
                    BookID.setText("");
                } else
                    JOptionPane.showMessageDialog(ReturnBookForm.this, "Unable to Return Book!",
                            "Returning Book Error!", JOptionPane.ERROR_MESSAGE);

            } else
                JOptionPane.showMessageDialog(ReturnBookForm.this, "The Book  is NOT Issued by THIS User!",
                        "Issuing Book Error!", JOptionPane.ERROR_MESSAGE);
        } else {
            if (TransBookDBConn.UserValidate(MatricsNo.getText()))
                JOptionPane.showMessageDialog(ReturnBookForm.this, "The Book  is NOT available in Library Database!",
                        "Returning Book Error!", JOptionPane.ERROR_MESSAGE);
            else if (TransBookDBConn.BookValidate(BookID.getText()))
                JOptionPane.showMessageDialog(ReturnBookForm.this, "The User is NOT available in Library Database!",
                        "Returning Book Error!", JOptionPane.ERROR_MESSAGE);
            else
                JOptionPane.showMessageDialog(ReturnBookForm.this,
                        "The Book  and User are NOT available in Library Database!", "Returning Book Error!",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReturnBookForm.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
