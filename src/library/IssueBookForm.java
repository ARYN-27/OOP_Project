                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(RYear, javax.swing.GroupLayout.PREFERRED_SIZE, 59,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(IYear, javax.swing.GroupLayout.PREFERRED_SIZE, 59,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addComponent(MatricsNo, javax.swing.GroupLayout.PREFERRED_SIZE, 335,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(106, 106, 106))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (TransBookDBConn.BookValidate(BookID.getText()) && TransBookDBConn.UserValidate(MatricsNo.getText())) {
            ...
            if (TransBookDBConn.Check(MatricsNoIDV) == 0)
                JOptionPane.showMessageDialog(IssueBookForm.this, "User has already Issued Maximum No of Books",
                        "Issue Error!", JOptionPane.ERROR_MESSAGE);
            else {
                if (TransBookDBConn.IssueBook(BookIDV, MatricsNoIDV, IFDate, RFDate) != 0) {

                    JOptionPane.showMessageDialog(IssueBookForm.this, "The Book  is Issued!", "Book Issued!",
                            JOptionPane.ERROR_MESSAGE);
                    BookID.setText("");
                    MatricsNo.setText("");
                } else
                    JOptionPane.showMessageDialog(IssueBookForm.this, "Unable to Issue Book!", "Issuing Book Error!",
                            JOptionPane.ERROR_MESSAGE);
            }

        } else {
            if (TransBookDBConn.UserValidate(MatricsNo.getText()))
                JOptionPane.showMessageDialog(IssueBookForm.this, "The Book  is NOT available in Library Database!",
                        "Issuing Book Error!", JOptionPane.ERROR_MESSAGE);
            else if (TransBookDBConn.BookValidate(BookID.getText()))
                JOptionPane.showMessageDialog(IssueBookForm.this, "The User is NOT available in Library Database!",
                        "Issuing Book Error!", JOptionPane.ERROR_MESSAGE);
            else
                JOptionPane.showMessageDialog(IssueBookForm.this,
                        "The Book  and User are NOT available in Library Database!", "Issuing Book Error!",
                        JOptionPane.ERROR_MESSAGE);
